...
class ProductDetailsPageFromAllProducts extends StatefulWidget {
  const ProductDetailsPageFromAllProducts({
    super.key,
  ...
  @override
  State<ProductDetailsPageFromAllProducts> createState() =>
      _ProductDetailsPageFromAllProducts();
}

class _ProductDetailsPageFromAllProducts
    extends State<ProductDetailsPageFromAllProducts> {
  int productCount = 1;
            ...
            children: [
              Center(
                child: ClipRRect(
                  ...
                  child: Image.network(
                    '$baseUrlImage/${widget.product.images[0].imageUrl}',
                    height: 250,
                    width: 250,
                    fit: BoxFit.cover,
                  ),
              ...
              const SizedBox(height: 20),
              Text(
                '${S.of(context).Price}: \$${widget.product.price}',
                style: const TextStyle(
                  fontSize: 18,
                  fontWeight: FontWeight.bold,
                  color: Colors.black,
              ...
              // const SizedBox(height: 10),
              // Text(
              //   'Amount: ${widget.product.stores[0].pivot.amount}',
              //   style: const TextStyle(
              //     fontSize: 16,
              //     fontWeight: FontWeight.w400,
              //     color: Colors.black,
